!function (t) {
    ...
    o.transform = void 0;n(4)(r, o);r.locals && (t.exports = r.locals);
}, function (t, e, n) {
    ...
    function o(t, e) {
        for (var n = [], r = {}, o = 0; o < t.length; o++) {
            ...
            var u = i[2];
            var c = i[3];
            var f = {css: a, media: u, sourceMap: c};
    ...
    function f(t, e) {
        ...
        if (e.singleton) {
            ...
            t.sourceMap && 'function' == typeof URL && 'function' == typeof URL.createObjectURL && 'function' == typeof URL.revokeObjectURL && 'function' == typeof Blob && 'function' == typeof btoa ? (n = u(e), r = d.bind(null, n, e), o = function () {
    ...
    function d(t, e, n) {
        var r = n.css;
        var o = n.sourceMap;
        var i = void 0 === e.convertToAbsoluteUrls && o;
        (e.convertToAbsoluteUrls || i) && (r = w(r)), o && (r += '\n/*# sourceMappingURL=data:application/json;base64,' + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + ' */');var s = new Blob([r], {
                type: 'text/css'
            });
var a = t.href;
